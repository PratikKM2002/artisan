  ...
  export default {
    ...
    search:'',
      ...
      headers: [
        ...
        { text: 'Manufacturer Name', value: 'manufacturer',filterable:false,align: 'center', },
        { text: 'Contact No.', value: 'phone_no',sortable: false,filterable:false, align: 'center',width:"200px",},
        { text: 'Material Price', value: 'mat_price',sortable: false,filterable:false,align: 'center', },
        { text: 'Material Quantity', value: 'mat_quantity',sortable: false,filterable:false,align: 'center', },
        { text: 'Actions', value: 'actions', sortable: false,filterable:false,align: 'center',width:"200px", },
      ],
      RawMaterial: [],
      editedIndex: -1,
      editedItem: {
